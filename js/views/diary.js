...
export default function DiaryView({
  ...
  return h("div", null, [
    ...
    DEV ? h("div", { class:"card", style:"border:dashed 1px #647; background:#0d0f15" }, [
      ...
      h("div", { class:"kv" }, [ h(Badge,null,`Path: ${pair.path}`), h(Badge,null,`Stage: ${pair.stage}`) ]),
      ...
      ...witnesses.map(w => h("div",{class:"kv",style:"flex-wrap:wrap; gap:6px"},[
        h(Badge,null,w),
        ...
        h(Button, {
          ...
          onClick: () => {
            ...
            appendDiaryEntry(diary, {
              ...
              path: pair.path, stage: pair.stage, tags:["#desire", `#with:${targetId}`], mood:["pensive"]
            });
            rerender();
          }
      ...
      h("div", { class:"kv", style:"align-items:flex-start; gap:8px" }, [
        ...
        h(Button,{ghost:true,onClick:()=>{
          ...
          appendFree(txt,{tags:["#free"]}); if (el) el.value = "";
        }},"Add")
      ])
    ]) : null,
    ...
    h("div", { class:"card diary-card" }, [
      ...
      ...Object.entries(grouped).map(([day, entries]) =>
        h("div",{class:"diary-day"},[
          ...
          ...entries.map((e,i)=> h("div",{class:"diary-hand",key:day+i},[
            h("p",null,e.text),
